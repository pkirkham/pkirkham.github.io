...
$$\beta=0.3333\log_{10}\left(k_{20}\right)+1.6667$$
...
$$\sigma_{ow}=\left[2.6628\left(\rho_{w}-\rho_{o}\right)^{-0.9136}\times\left(\rho_{w}-\rho_{o}\right)\right]^{4}$$
...
{% raw %}
$$\sigma_{gw}=\left[\frac{1.58\left(\rho_{w}-\rho_{g}\right)+1.76}{{T_{r}}^{0.3125}}\right]^4$$
{% endraw %}
...
$$P_{c'}=\left(\rho_{w}-\rho_{h}\right)\times{HAGWC}$$

Where:

 - ρ<sub>w</sub> = Water density, psi/ft (0.43353 psi/ft for pure water)
 - ρ<sub>h</sub> = Hydrocarbon fluid density, psi/ft
...
$$J\left(S_{w}\right)=\frac{0.216601\cdot{P_{c'}}}{\sigma\cdot{\cos\theta}}\sqrt{\frac{k}{\phi}}$$

Where:

 - P<sub>c'</sub> = Capillary pressure above apparent gas-water contact (adjusted for displacement pressure), psia
 - k = Rock permeability, millidarcy
 - φ = Rock porosity, fraction
 - σ = Interfacial tension, dynes/cm
 - θ = Contact angle, degrees
...
$$S_{w}=\frac{\left(1-S_{wirr}\right)}{e^{J^{\frac{1}{\beta}}}}+S_{wirr}$$
...
$$S_{w}=\frac{\left(1-\frac{C}{\phi^Q}\right)}{e^{J^{\frac{1}{\beta}}}}+\frac{C}{\phi^Q}$$
...
$$S_{wI}=S_{wD}-\Delta{S_{w}}$$

$$\Delta{S_{w}}=s\cdot{S_{wD}}+int$$

$$int=a+b\cdot{\ln{k}}+c\cdot{S_{wD,orig}}$$

Where:

 - S<sub>wI</sub> = Imbibition water saturation for current gas-water contact, fraction
 - S<sub>wD</sub> = Drainage water saturation for current gas-water contact, fraction
 - k = Rock permeability, millidarcy
 - S<sub>wD,orig</sub> = Original drainage water saturation at current depth prior to imbibition, fraction
...
$$s=\frac{\left(0.0942\cdot{S_{wD,min}}+0.8323\right)+\left(-0.0077\cdot{\ln{k}}+0.9039\right)}{2}$$

$$a=-\left(s+c\right)\cdot{S_{wD,min}}-b\cdot{\ln{k}}$$
...
## References
 - Adams, S. 2003. Modeling Imbibition Capillary Pressure Curves. Paper presented at the SPE Annual Technical Conference and Exhibition, Denver, Colorado, 5 October. SPE-84298-MS. [https://doi.org/10.2118/84298-MS](https://doi.org/10.2118/84298-MS)
 - Bentsen, R. G. and Anli, J. 1976. A New Displacement Capillary Pressure Model. _J Can Pet Technol_ **15** (03): 75-79. PETSOC-76-03-10. [https://doi.org/10.2118/76-03-10](https://doi.org/10.2118/76-03-10)
 - [Harris, R. G. and Goldsmith, P. J. 2001. Water Saturation Analysis and Interpretation of a Tilted Free-water Level in the Joanne/Judy Chalk Field, U.K. North Sea. Paper presented at the SPWLA 42nd Annual Logging Symposium, Houston, Texas, 17 June. SPWLA-2001-EEE.](https://onepetro.org/SPWLAALS/proceedings-abstract/SPWLA-2001/SPWLA-2001/SPWLA-2001-EEE/27254)
 - [Wu, T. 2004. _Permeability Prediction and Drainage Capillary Pressure Simulation in Sandstone Reservoirs_. PhD dissertation, Texas A&M University, Texas (December 2004).](https://oaktrust.library.tamu.edu/server/api/core/bitstreams/9d20748d-9cd5-408a-ab3e-222acc097e45/content)
 - [Wu, T. and Berg, R. R. 2003. A Method For Synthesizing and Averaging Capillary Pressure Curves. Extended abstract presented at AAPG Annual Convention, Salt Lake City, Utah, 11-14 May.](https://www.searchanddiscovery.com/pdfz/abstracts/pdf/2003/annual/extend/ndx_77382.PDF.html)